> **Preserved upstream document.** This is the root README from the downloaded source snapshot,
> retained for provenance and its long-form external catalog. Links, claims, and project status in
> this file belong to the upstream snapshot and are not local validation results.
